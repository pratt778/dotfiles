...
vim.keymap.set('i', '<C-z>', '<Esc>:undo<CR>', { desc = 'Undo' })
...
vim.keymap.set('n', '<F5>', ':w<CR>:split | terminal python3 %<CR>', { desc = 'Run Python file' })
...
-- Duplicate line like VSCode Alt+Shift+Down
vim.keymap.set('n', '<A-S-Down>', ':t.<CR>', { desc = 'Duplicate line' })
...
vim.keymap.set('n', 'x', '"_x', { desc = 'Delete char without copy' })

-- Quick split navigation
vim.keymap.set('n', '<leader>v', ':vsplit<CR>', { desc = 'Vertical split' })
vim.keymap.set('n', '<leader>h', ':split<CR>', { desc = 'Horizontal split' })
-- Ctrl+D to delete entire line like VSCode
vim.keymap.set('n', '<C-d>', 'dd', { desc = 'Delete line' })
...
vim.keymap.set('n', '<leader>r', ':%s/<C-r><C-w>//g<Left><Left>', { desc = 'Search and replace word under cursor' })
  ...
  -- Autosave after leaving insert mode or text change
vim.api.nvim_create_autocmd({ "InsertLeave", "TextChanged" }, {
  pattern = "*",
  command = "silent! write",
})
-- Highlight yanked text briefly
-- (already in kickstart, skip if exists)
...
do
  ...
  require('which-key').setup {
    ...
    { '<leader>r', group = 'Run Python' },
    { '<leader>k', group = 'Kill Program' },
...
require('nvim-autopairs').setup {}
  ...
  require('mini.files').setup { use_as_default_explorer = false }
...
╚═╝  ╚═══╝╚══════╝ ╚═════╝   ╚═══╝  ╚═╝╚═╝     ╚═╝
  ...
  items = {
    starter.sections.recent_files(5, false, false),
    {
      ...
      { name = 'Update Plugins', action = 'lua vim.pack.update()',                   section = 'Plugins' },
      { name = 'Check Health',   action = 'checkhealth',                             section = 'Plugins' },
      { name = 'Edit Config',    action = 'edit ~/.config/nvim/init.lua',            section = 'Plugins' },
  ...
  footer = [["The quieter you become, the more you are able to hear"  — Kali Linux]],
})
...
do
  ...
  vim.keymap.set('n', '<leader>r', ':w<CR>:split | terminal python3 %<CR>', { desc = 'Run Python' })
  vim.keymap.set('n', '<leader>k', function()
  vim.cmd('bdelete! term://*')
end, { desc = 'Kill terminal/program' })
